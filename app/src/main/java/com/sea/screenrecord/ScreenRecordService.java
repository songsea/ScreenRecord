...
public class ScreenRecordService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        RecorderView.getInstance(this.getApplication()).showRecord();
    ...
    public void onDestroy() {
        ...
        RecorderView.getInstance(this.getApplication()).hideRecord();
    }
    ...
    private void getScreenBaseInfo() {
        ...
        Log.d(TAG, "getScreenBaseInfo screenwidth " + mScreenWidth + " screenheight " + mScreenHeight + " screendensity " + mScreenDensity);
    }
